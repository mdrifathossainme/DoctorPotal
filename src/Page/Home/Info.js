...
const Info = () => {
    return (
       ...
       <InfoCard title={'Opening Hours'} bgClass="bg-gradient-to-r from-secondary to-primary" img={clock} />
       <InfoCard title={'Visit our location'} bgClass='bg-accent' img={marker} />
